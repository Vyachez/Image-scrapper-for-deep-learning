...
# Equaliser.py:
Makes the number of images for each category within all directories (training, validation, samples) equal to fit the deep learning algorithm (I am following your great advice to structure the dataset in right order).
